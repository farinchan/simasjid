                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        <thead>
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Social Media</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ $user->instagram?? '#' }}">
                                            <img src="{{ asset('back/media/svg/social-logos/instagram.svg') }}"
                                                alt="facebook" class="w-20px me-2" />
                                        </a>
                                        <a href="{{ $user->linkedin?? '#' }}">
                                            <img src="{{ asset('back/media/svg/social-logos/linkedin.svg') }}"
                                                alt="facebook" class="w-20px me-2" />
                                        </a>
                                        <a href="{{ $user->github?? '#' }}">
                                            <img src="{{ asset('back/media/svg/social-logos/github.svg') }}"
                                                alt="facebook" class="w-20px me-2" />
                                        </a>
